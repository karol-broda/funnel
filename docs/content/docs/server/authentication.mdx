...
seo:
  title: "Authentication: API keys, GitHub OAuth, and OIDC for tunnels"
  description: "Secure your tunnel server with scoped API keys, GitHub OAuth login, or any OIDC provider (GitLab, Google, Keycloak). Manage access control and key expiry."
  keywords:
    - tunnel authentication
    - tunnel API key
    - GitHub OAuth tunnel server
    - OIDC tunnel login
    - scoped API key permissions
    - tunnel access control
    - Keycloak tunnel authentication
---

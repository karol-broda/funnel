...
seo:
  title: "Automatic TLS: Let's Encrypt wildcard certs for tunnel subdomains"
  description: "Enable automatic HTTPS for all tunnel subdomains using Let's Encrypt DNS-01 challenges. Supports Cloudflare, Route53, and custom exec DNS providers."
  keywords:
    - automatic TLS tunnel
    - Let's Encrypt wildcard certificate
    - DNS-01 challenge tunnel
    - Cloudflare DNS tunnel TLS
    - Route53 tunnel certificate
    - HTTPS tunnel subdomain
    - self-hosted tunnel TLS
---

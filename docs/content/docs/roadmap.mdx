...
<Card title="✅ server api" description="comprehensive rest api for tunnel management and monitoring" />
<Card title="✅ tunnel statistics" description="detailed metrics, historical data, and performance monitoring" />
<Card title="✅ openapi documentation" description="interactive api docs with swagger ui integration" />
<Card title="✅ client authentication" description="api key-based authentication for secure access" />
</Cards>
</Tab>

<Tab value="In Progress">
<Cards>
<Card title="🔄 web dashboard" description="browser-based tunnel monitoring and control interface" />
</Cards>

<Callout title="next milestone" intent="tip">
our current focus is on building a web dashboard for visual tunnel management.
</Callout>
</Tab>

<Tab value="Planned">
<Cards>
<Card title="📋 client api" description="programmatic client control and configuration sdk" />
...
- token creation, listing, and revocation via cli
- tokens hashed with sha-256 on server (secure storage)
- client config file support for token storage

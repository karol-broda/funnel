module github.com/karol-broda/go-tunnel-proxy/cmd/tunnel-server

go 1.21

require (
	github.com/karol-broda/go-tunnel-proxy/server v0.0.0-00010101000000-000000000000
...
replace github.com/karol-broda/go-tunnel-proxy/server => ../../server

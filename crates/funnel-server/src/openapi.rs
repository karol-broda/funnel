...
#[openapi(
    ...
    components(
        schemas(
            ...
            crate::tunnel::manager::TunnelInfo,
            crate::tunnel::stats::TunnelStatsSnapshot,
            crate::db::api_keys::ApiKeyView,
            crate::api::keys::CreateKeyRequest,
            crate::api::keys::CreateKeyResponse,
            crate::db::users::User,
            crate::db::teams::Team,
            crate::db::teams::TeamMembership,
            crate::db::tunnel_sessions::TunnelSession,
            crate::api::accounts::AccountView,
            crate::error::ApiErrorBody,
            crate::api::users::SetRoleRequest,
            crate::api::teams::CreateTeamRequest,
            crate::api::teams::AddMemberRequest,
            crate::api::teams::SetRoleRequest,
        )
    ),
